...
module.exports.postPdf = async (req, res) => {
  ...
  try {
    ...
    // Wait for window.print to finish
    await page.evaluate(() => {
    ...
    // Wait for a short duration (adjust as needed) to ensure PDF is generated
    ...
    const mailOptions = {
      from: "furqan.rahim@flowtechnologies.io",
      to: emailAddresses.join(', '), // Join multiple email addresses with comma
      subject: "PDF Attachment",
      text: "Attached is the PDF you requested.",
      attachments
    };
...
//     // Wait for navigation to complete (if applicable)
//     // await Promise.all([
//     //   page.waitForNavigation(),
//     //   page.click('yourButtonSelector') // Replace with the actual selector or action triggering navigation
//     // ]);

//     // Capture a screenshot before waiting for the selector
//     await page.screenshot({ path: 'debug-screenshot-before.png' });

//     // Wait for the element with class 'new-data' to appear (replace with your actual selector)
//     console.log("Waiting for selector to appear...");
//     await page.waitForSelector('.new-data', { timeout: 60000 });
//     console.log("Selector found!");

//     // Capture another screenshot after waiting for the selector
